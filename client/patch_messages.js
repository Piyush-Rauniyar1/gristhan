...
const file = '/Users/piyushrauniyar/Desktop/Stack-Rebels/client/src/pages/VendorHome.jsx';
          ...
          {selectedConv ? (
            <>
              ...
              <form onSubmit={handleSendMessage} style={{ padding: '16px', background: '#fff', borderTop: '1px solid #e5e7eb', display: 'flex', gap: 10 }}>
                <input type="text" value={newMessage} onChange={e => setNewMessage(e.target.value)} placeholder="Type your message..." style={{ flex: 1, padding: '12px 16px', borderRadius: 999, border: '1.5px solid #e5e7eb', fontSize: 13, outline: 'none' }} />
...
content = content.replace('function HostReviewsSection({ user }) {', replacement);
fs.writeFileSync(file, content);
console.log('Patched VendorHome.jsx');
